CREATE TABLE [dbo].[GasolineraCreditos]
(
	[GasCreditoId] INT NOT NULL PRIMARY KEY IDENTITY, 
	...
	CONSTRAINT [FK_GasolineraCreditos_Gasolineras] FOREIGN KEY ([GasolineraId]) REFERENCES Gasolineras(GasolineraId)
)
