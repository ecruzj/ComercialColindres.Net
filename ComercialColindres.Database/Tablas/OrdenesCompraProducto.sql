CREATE TABLE [dbo].[OrdenesCompraProducto]
(
	[OrdenCompraProductoId] INT NOT NULL PRIMARY KEY IDENTITY, 
	...
	CONSTRAINT [FK_OrdenesCompraProducto_Plantas] FOREIGN KEY ([PlantaId]) REFERENCES ClientePlantas(PlantaId)
)
